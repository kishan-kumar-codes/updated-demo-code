...
const EventsList = () => {
    return (
        <div className="mt-4">
            {events.map((event) => (
                <div key={event.id} className="pr-[17px] mb-2 flex items-center rounded-lg ">
                    <div className="mx-[10px] flex-[.2] flex flex-col items-center">
                        <p className="font-bold text-palatinatePurple text-[20px] md:text-[15px]">{event.day}</p>
                    ...
                    <div className="flex bg-white flex-[.8] items-center justify-between mt-2 pl-[14px] pr-[12px] rounded-lg py-[12px] text-palatinatePurple">
                        <div>
                            <p className="font-bold text-[16px] md:text-[14px]">{event.name}</p>
                            <p className="text-[14px] md:text-[11px]">{event.time}</p>
