        ...
        <div className="fixed inset-0  flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-cultured rounded-lg shadow-lg p-2 w-[304px]  ">
                ...
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-[20px] text-darkSilverColor font-bold">John’s Calendar</h2>
                    ...
                    <ul className="flex ">
                        {tabs.map((tab) => (
                            <li
                                ...
                                className={`cursor-pointer mx-1 text-[12px] font-bold pb-2 ${activeTab === tab
                                    ? ' text-palatinatePurple font-semibold'
                ...
                <div>
                        ...
                        <div>
                            <div className="mb-4">
                                ...
                                <div className="flex items-center h-fit space-x-2">
                                    <input
                                        type="text"
                                        className="w-full  border-none outline-none bg-white rounded px-3 py-2 text-[12px]"

                                    />
                                    <button className="bg-limeGreen h-full font-bold rounded px-3 py-1">
                                        Copy
                                    </button>
                                </div>
                    ...
                    {activeTab === 'One Time Link' && (
                        <div>
                            <div className="flex items-center space-x-2">
                                <input
                                    type="text"
                                    className="w-full  border-none outline-none bg-white rounded-lg px-3 py-2 text-[12px]"
                            ...
                            <p className='text-[9px] text-darkSilverColor font-bold mt-[7px]'>
                                Share your availability every time with a unique link that expires after
                                a booking, ensuring controlled access.
                            </p>
                        </div>
                    )}
                    ...
                    {activeTab === 'Embed Code' &&
                        <div>
                            ...
                            <p className='text-[9px] text-darkSilverColor font-bold mt-[7px] ml-2'>
                                Share your availability every time with a unique link that expires after
                                a booking, ensuring controlled access.
                            </p>

                            <textarea className='w-full min-h-[125px] text-[12px] text-darkSilverColor rounded-lg mt-[21px]  py-[8px] px-[14px]' name="" id="" value='
