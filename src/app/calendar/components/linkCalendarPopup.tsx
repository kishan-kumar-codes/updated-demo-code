...
export const LinkCalendar: React.FC<PropsInterface> = ({
  handleClose,
  handleStep,
}) => {
  return (
    <div className="fixed top-2/4 left-2/4  -translate-x-2/4 -translate-y-2/4 rounded-lg px-[14px] w-[304px] lg:w-[30%] z-10 h-[363px] lg:h-[480px] bg-cultured pb-[10px] ">
      <div className="flex justify-between items-start mt-[13px]">
        <h5 className="text-[20px] lg:text-[32px] font-bold text-darkSilverColor ">
          Linked Calendar
        </h5>
      ...
      <p className="text-[10px] lg:text-[18px] leading-5 font-bold text-darkSilverColor mt-[21px]">
        All new events created in the system will be added to your linked
        calendar and all events in the linked calendar will be synced to the
        system.
      </p>
      ...
      <div className="flex mt-[20px]">
        ...
        <p className="text-[10px] text-darkSilverColor">
      ...
      <div className="flex justify-end mt-[20px]">
        <button
          onClick={() => handleStep()}
          className="py-[5px] px-[10px] text-[12px] font-bold rounded bg-[#40f440]">
          Save
        </button>
        <button
          onClick={() => handleClose()}
          className="py-[5px] px-[10px] text-[12px] font-bold bg-[#ba0416] text-white ml-[8px] rounded">
          Cancel
        </button>
      </div>
    </div>
