...
const Calendar30 = () => {
  ...
  return (
    <LayoutView
      Childrens={
        <div className="relative pb-[30px] md:pb-0 flex h-fit overflow-y-scroll w-full bg-cultured">
          <div className="mx-[18px] flex flex-col md:flex-row mt-[19px] pb-[38px] md:pb-0 w-full bg-chinesWhite rounded-lg">
            <div className="w-full  md:py-14 h-full md:border-r-[1px] md:border-darkSilverColor md:w-[25%]">
              <div className="bg-palatinatePurple md:bg-transparent flex pl-[16px] py-[11px] text-[16px] font-bold rounded-lg text-white md:text-palatinatePurple">
                <h4>John’s Calendar</h4>
              </div>
              <div className="h-full px-[16px]">
                <div className="flex flex-col rounded-xl mt-[18px]  p-[11px]  h-[98px] bg-white md:bg-chinesWhite">
            ...
            <div className="w-full h-full items-center space-y-4 px-5 md:px-[80px] lg:px-[150px] md:py-14 flex flex-col justify-center">
              <h5 className="text-[16px] font-bold text-palatinatePurple w-full mt-[32px]">
                Enter Details
              </h5>
              ...
              <div className="mt-[14px] w-full flex items-start">
                <input type="checkbox" />
