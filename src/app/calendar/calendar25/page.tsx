            ...
            <div className="p-6 mx-auto  rounded-lg ">
              ...
              <div className="mb-4">
                ...
                <div className="flex">
                  <input
                    ...
                    className="w-full md:w-[30%] px-3 py-2 rounded-bl-lg border-none text-darkSilverColor outline-none bg-cultured rounded-tl-lg h-[27px]"
                  ...
                  {/* <input
                    ...
                    readOnly
                  /> */}
                  <button className="px-[15px] md:text-start text-[12px] h-[27px] md:w-[100%] bg-gray-100 text-darkSilverColor font-bold rounded-xl rounded-br-lg">
                    newcalendar12
                  </button>
                </div>
              </div>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border-none outline-none bg-cultured rounded-lg py-5 h-[27px]"
                />
              </div>
              ...
              <div className="mb-4">
                ...
                <MultiSelect
                  className="w-full  min-h-[27px] text-[12px]  bg-[#f4f4f4]   outline-none rounded-xl mt-[6px] mb-[11px]"
                  onRemove={() => null}
                  onSelect={() => null}
                  options={[
                    {
                ...
                <div className="flex w-full justify-end items-center">
                  <select
                    value={selectedTeamMember}
                    onChange={(e) => setSelectedTeamMember(e.target.value)}
                    className="w-full px-3 h-[27px] text-[12px] md:hidden bg-[#f4f4f4] border-none outline-none rounded">
                    <option>John Doe</option>
                    <option>Jane Doe</option>
                  </select>
                  ...
                  <select
                    ...
                    className="ml-2 px-3 h-[27px] text-[12px] border-none bg-[#f4f4f4] outline-none rounded-xl">
                  ...
                  <select
                    onChange={(e) => setSelectedTeamMember(e.target.value)}
                    className="ml-2 px-5 h-[27px] text-[12px] border-none bg-[#f4f4f4] outline-none rounded-xl">
              ...
              {/* Meeting Location */}
              <div className="mb-4 md:flex justify-end w-full">
                <label className="block text-darkSilverColor md:hidden text-[12px] font-bold mb-1">
                  Meeting Location
                </label>
                <div className="flex md:w-[29%] items-center">
                  <input
                    type="text"
