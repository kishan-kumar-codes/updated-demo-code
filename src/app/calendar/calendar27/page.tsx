    ...
    <LayoutView
      Childrens={
        <div className="relative flex pb-[30px] h-full overflow-y-scroll w-full bg-cultured">
          ...
          <div className="mx-[18px] flex-1 h-fit mt-[19px] pb-[36px] bg-chinesWhite rounded-lg">
            <div className="bg-palatinatePurple flex pl-[16px] py-[11px] text-[16px] font-bold rounded-lg text-white">
              <h4>Availability</h4>
            </div>
            <div className="px-[17px] md:px-[30px] py-[15px]  mx-auto  rounded-lg ">
              <p className="text-[12px] lg:px-[20px] text-darkSilverColor border-b font-bold mb-4">
                Set your availability for the calendar here.
              </p>
              <h5 className="text-darkSilverColor lg:px-[20px] text-[15px] md:w-[50%] border-b font-bold mb-4">
              ...
              {Object.keys(availability).map((day) => (
                <div
                  key={day}
                  className="mb-4 flex items-center lg:w-[60%] md:gap-8 border-b justify-between lg:px-[20px]">
                  <input
                    type="checkbox"
                    checked={availability[day].enabled}
                    onChange={() => toggleAvailability(day)}
                    className="mr-2 h-[30px] bg-[#c7c6c6] md:w-[15px]"
                  />
                  ...
                  <div className="flex">
                    <input
                      ...
                      className="w-[68px] md:w-[80px] text-[12px] text-darkSilverColor font-bold px-3 py-5 bg-[#f4f4f4] h-[30px] md:h-[40] rounded md:rounded-xl mr-2"
                      onChange={(e) =>
                        setAvailability((prev) => ({
                          ...prev,
                    ...
                    <input
                      ...
                      disabled={!availability[day].enabled}
                      className="w-[68px] md:w-[80px] text-[12px] bg-[#f4f4f4] text-darkSilverColor font-bold px-3 py-5  h-[30px] md:h-[40] rounded md:rounded-xl mr-2"
                      onChange={(e) =>
                        setAvailability((prev) => ({
                          ...prev,
                  ...
                  <button>
                    <FontAwesomeIcon icon={faPlus} color="#6d6d6d" />
                  </button>
              ...
              <div className="flex justify-end lg:justify-center ">
                <button className="px-[16px] py-[12px] lg:mr-12 md:px-[13px] md:py-[8px] bg-palatinatePurple text-white rounded-lg mb-4">
                  Add Date Specific Hours
                </button>
              </div>

              <div className="border-y py-8 lg:px-[20px]">
                {/* Look Busy */}
                <div className="mb-4 flex lg:w-[60%] md:gap-8 md:justify-between items-center">
                  <ToggleSwitch />
                  ...
                  <input
                    type="number"
                    disabled={!lookBusy}
                    className="w-24 md:w-[210px] px-3 text-end border-none outline-none h-[27px] rounded-lg bg-cultured"
                    placeholder="%"
                  />
                </div>
              ...
              <div className="lg:grid grid-cols-2 lg:px-[20px] lg:gap-x-20 lg:w-[80%]">
                {/* Meeting Settings */}
                <div className="mb-4">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex text-[12px] rounded-lg overflow-hidden">
                    <input
                      type="number"
                      value={preBufferTime}
                      onChange={(e) =>
                ...
                <div className="mb-4 w-full">
                  <label className="block text-darkSilverColor text-[12px] font-bold mb-1">
                    Customize The Text For Your Submit Button
                  </label>
                  <div className="flex w-full text-[12px] rounded-lg overflow-hidden">
                    <select
                      name=""
                      id=""
                      className="w-full px-3 py-2   outline-none h-[27px] rounded-tl-lg  rounded-bl-lg bg-[#f4f4f4]">
                      ...
                      <option value="Schedule A Service Call">
