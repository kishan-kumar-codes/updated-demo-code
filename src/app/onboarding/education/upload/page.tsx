        ...
        <div className="px-[43px] flex items-center w-full flex-col relative ">
          ...
          <div className="flex py-1 relative lg:py-4 justify-center">
            <Select value={jobTitle || ""} onValueChange={handleJobTitleChange}>
              <SelectTrigger className="w-[137px] h-[33px] lg:h-12 mt-[13px] text-[12px] bg-white md:text-lg text-darkSilverColor pl-[18px] py-[10px] rounded-lg lg:text-[26px] lg:w-[250px] lg:rounded-2xl lg:px-4 lg:py-5">
                <SelectValue placeholder="Choose one" />
              </SelectTrigger>
              <SelectContent className="bg-white">
                <SelectItem value="roofer">Roofer</SelectItem>
                <SelectItem value="technician">Technician</SelectItem>
                <SelectItem value="carpet cleaner">Carpet Cleaner</SelectItem>
              </SelectContent>
            </Select>
            {/* <div className="absolute right-2 top-1/2 transform translate-y-1/2 pointer-events-none">
              <ChevronDown color="#6D6D6D" size={20} />
            </div> */}
          </div>
          <div
