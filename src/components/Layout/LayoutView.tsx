...
import ContactDetails from "../allContacts/page";
      ...
      Childrens={
        <div className="relative flex flex-col w-full ">
          <div className="grid grid-cols-1 max-h-screen overflow-hidden lg:grid-cols-[37%_63%]  ">
            ...
            {showFilterDialog && (
              <div className="h-full lg:h-[80vh] w-full flex flex-row-reverse absolute right-0 lg:translate-y-[2%] lg:transform lg:translate-x-[-64%]">
                <div
                  onClick={() => handleFilters(false)}
                  className="flex-grow sm:transparentBg h-full"
                />
          ...
          <div className="lg:col-span-2 fixed bottom-0 w-full flex lg:hidden  mt-4">
            <BottomNavigation />
          </div>
        </div>
      }
